...
Route::middleware('auth:user', 'verified')->group(function () {
    ...
    Route::controller(CandidateController::class)->prefix('candidate')->middleware('candidate')->name('candidate.')->group(function () {
        ...
        Route::get('cv_template', 'cv_template')->name('cv_template');
        Route::get('resume1', 'resume1')->name('resume1');
        Route::get('resume2', 'resume2')->name('resume2');
        Route::get('resume3', 'resume3')->name('resume3');
    });
