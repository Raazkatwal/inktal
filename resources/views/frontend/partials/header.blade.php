                    ...
                    <div class="n-header--bottom__left d-flex align-items-center">
                        ...
                        <form action="{{ route('website.job') }}" method="GET" id="search-form"
                            ...
                            <div class="search-box">
                                @php
                                 if (auth()->check()) {
                                        $users = auth()->user(); // Retrieves an array of roles
                                ...
                                <select id="headerSearch" onchange="changeSearchSelection()" class="form-select"
                                    ...
                                    <option @selected(session('header_search_role') == 'candidate')
                                 @if(auth()->check())
                                    @if(auth()->user()->role != 'candidate') value="candidate" @else hidden @endif>
                                    {{ __('candidate') }}
                                </option>
                                @endif
